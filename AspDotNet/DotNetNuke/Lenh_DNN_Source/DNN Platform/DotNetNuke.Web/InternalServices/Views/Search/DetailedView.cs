...
namespace DotNetNuke.Web.InternalServices.Views.Search
{
    ...
    public class DetailedView : BasicView
    {
        ...
        /// <summary>Gets or sets number of Likes associated with Content.</summary>
        /// <remarks>Content with more Likes is ranked higher.</remarks>
        public int Likes { get; set; }

        /// <summary>Gets or sets number of Comments associated with Content.</summary>
        /// <remarks>Content with more Comments is ranked higher.</remarks>
        public int Comments { get; set; }

        /// <summary>Gets or sets number of Views associated with Content.</summary>
