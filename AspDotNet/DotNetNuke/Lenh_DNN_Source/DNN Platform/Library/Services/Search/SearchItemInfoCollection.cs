...
namespace DotNetNuke.Services.Search
{
    ...
    public class SearchItemInfoCollection : CollectionBase
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="SearchItemInfoCollection"/> class containing the elements of the specified source collection.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="SearchItemInfoCollection"/> class containing the specified array of <see cref="SearchItemInfo">SearchItemInfo</see> objects.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="SearchItemInfoCollection"/> class containing the specified array of <see cref="SearchItemInfo">SearchItemInfo</see> objects.</summary>
        /// <param name="value">An <see cref="ArrayList"/> of <see cref="SearchItemInfo">SearchItemInfo</see> objects with which to initialize the collection.</param>
        ...
        /// <para>In VB.Net, this property is the indexer for the <see cref="SearchItemInfoCollection">SearchItemInfoCollection</see> class.</para>
        /// </summary>
        ...
        /// <summary>Add an element of the specified <see cref="SearchItemInfo">SearchItemInfo</see> to the end of the collection.</summary>
        ...
        /// <summary>Gets the index in the collection of the specified <see cref="SearchItemInfoCollection">SearchItemInfoCollection</see>, if it exists in the collection.</summary>
        ...
        /// <summary>Add an element of the specified <see cref="SearchItemInfo">SearchItemInfo</see> to the collection at the designated index.</summary>
        ...
        /// <summary>Remove the specified object of type <see cref="SearchItemInfo">SearchItemInfo</see> from the collection.</summary>
        ...
        /// <summary>Gets a value indicating whether the collection contains the specified <see cref="SearchItemInfoCollection">SearchItemInfoCollection</see>.</summary>
        ...
        /// <summary>Copies the elements of the specified <see cref="SearchItemInfo">SearchItemInfo</see> array to the end of the collection.</summary>
        ...
        /// <param name="value">An <see cref="ArrayList"/> of type <see cref="SearchItemInfo">SearchItemInfo</see> containing the objects to add to the collection.</param>
        ...
        /// <summary>Adds the contents of another <see cref="SearchItemInfoCollection">SearchItemInfoCollection</see> to the end of the collection.</summary>
        ...
        /// <summary>Copies the collection objects to a one-dimensional <see cref="Array">Array</see> instance beginning at the specified index.</summary>
        ...
        /// <summary>Creates a one-dimensional <see cref="Array">Array</see> instance containing the collection items.</summary>
