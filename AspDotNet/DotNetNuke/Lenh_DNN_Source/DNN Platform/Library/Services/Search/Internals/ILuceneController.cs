...
namespace DotNetNuke.Services.Search.Internals
{
    ...
    internal interface ILuceneController
    {
        ...
        /// <summary>Returns number of total documents in the search index (including deleted ones).</summary>
        /// <returns>Number of total documents in the search index (including Deletions).</returns>
        int MaxDocsCount();

        /// <summary>Returns number of total searchable documents in the search index.</summary>
        /// <returns>Number of total searchable documents in the search index.</returns>
        int SearchbleDocsCount();

        /// <summary>Returns if the current search index has deletions.</summary>
        /// <returns>Whther the search index has deletions or not.</returns>
        bool HasDeletions();

        /// <summary>Returns current search indexs general information.</summary>
