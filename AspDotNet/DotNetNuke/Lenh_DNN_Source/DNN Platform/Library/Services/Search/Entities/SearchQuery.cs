...
namespace DotNetNuke.Services.Search.Entities
{
    ...
    /// <summary>Criteria to search for.</summary>
    ...
    public class SearchQuery
    {
        ...
        /// <summary>Gets or sets a key to uniquely identify a document in the Index.</summary>
        public string UniqueKey { get; set; }

        /// <summary>Gets or sets keywords to search for.</summary>
        public string KeyWords { get; set; }

        /// <summary>Gets or sets a collection of Portal Ids of the Site to perform Search upon. This field must be specified or else Portal 0 will be searched by default.</summary>
        /// <remarks>Search cannot be executed across Sites.</remarks>
        public IEnumerable<int> PortalIds { get; set; }

        /// <summary>Gets or sets a collection of Search Type Ids that should be searched upon [Optional].</summary>
        public IEnumerable<int> SearchTypeIds { get; set; }

        /// <summary>Gets or sets a collection of Module Def Ids that should be searched upon [Optional]. Match is performed only when a SearchTypeId for Module Search Crawler Id.</summary>
        public IEnumerable<int> ModuleDefIds { get; set; }

        /// <summary>Gets or sets module Id to restrict Search. Value > 0 is used only.</summary>
        public int ModuleId { get; set; }

        /// <summary>Gets or sets role Id to restrict Search. Value > 0 is used only.</summary>
        public int RoleId { get; set; }

        /// <summary>Gets or sets tab Id to restrict Search. Value > 0 is used only.</summary>
        public int TabId { get; set; }

        /// <summary>Gets or sets locale to restrict Search to. This field can be left empty for single language site.</summary>
        /// <remarks>E.g. A value en-US or nl-NL can specified to restrict search to a single locale .</remarks>
        public string Locale { get; set; }

        /// <summary>Gets or sets begin Date of the time when Content was last modified (in Utc). This field is optional.</summary>
        public DateTime BeginModifiedTimeUtc { get; set; }

        /// <summary>Gets or sets end Date of the time when Content was last modified (in Utc). This field is optional.</summary>
        public DateTime EndModifiedTimeUtc { get; set; }

        /// <summary>Gets or sets restrict search to specific tags. This field is optional.</summary>
        ...
        /// <summary>Gets or sets culture Code associated with the content.</summary>
        /// <remarks>Culture-Neutral content is always returned even though this value is specfied.</remarks>
        public string CultureCode { get; set; }

        /// <summary>Gets or sets sort option of the search result. This field is optional.</summary>
        public SortFields SortField { get; set; }

        /// <summary>Gets or sets sort option of the search result. This field is optional.</summary>
        public SortDirections SortDirection { get; set; }

        /// <summary>Gets or sets name of the custom sort field, works with SortFields.CustomNumericField or SortFields.CustomStringField option.</summary>
        ...
        /// <summary>Gets or sets a value indicating whether set this to true to perform perform WildCard Search.</summary>
        ...
        /// <summary>Gets or sets restrict search to specific Keywords. This field is optional. Lookup is done in the SearchDocument.Keywords collection.</summary>
        ...
        /// <summary>Gets or sets restrict search to specific NumericKeys. This field is optional.</summary>
        /// <remarks>This is key-value pair, e.g. "ItemId","888".</remarks>
        /// <remarks>An empty dictionary means this is property is not used.</remarks>
        public IDictionary<string, int> NumericKeys { get; set; }

        /// <summary>Gets or sets a value indicating whether set this to true to allow search in word.</summary>
