...
namespace DotNetNuke.Entities.Content.Workflow
{
    ...
    {
        /// <summary>This method returns the paginated list of Items that are associated with a workflow.</summary>
        ...
        /// <summary>This method returns the total number of Content Items that are associated with any State of a workflow (even the Published state).</summary>
        /// <param name="workflowId">Workflow Id.</param>
        ...
        /// <summary>This method return the list of the Workflows defined for the portal.</summary>
        /// <param name="portalId">Portal Id.</param>
        /// <returns>List of the Workflows for the portal.</returns>
        IEnumerable<Entities.Workflow> GetWorkflows(int portalId);

        /// <summary>This method adds a new workflow. It automatically add two system states: "Draft" and "Published".</summary>
        ...
        /// <summary>this method update a existing workflow.</summary>
        /// <param name="workflow">Workflow Entity.</param>
        /// <exception cref="DotNetNuke.Entities.Content.Workflow.Exceptions.WorkflowNameAlreadyExistsException">Thrown when a workflow with the same name already exist for the portal.</exception>
        void UpdateWorkflow(Entities.Workflow workflow);

        /// <summary>This method hard deletes a workflow.</summary>
        /// <param name="workflow">Workflow Entity.</param>
        ...
        /// <summary>This method returns a workflow entity by Id.</summary>
        /// <param name="workflowId">Workflow Id.</param>
        /// <returns>Workflow Entity.</returns>
        Entities.Workflow GetWorkflow(int workflowId);

        /// <summary>This method returns a workflow entity by Content Item Id. It returns null if the Content Item is not under workflow.</summary>
