...
namespace DotNetNuke.Entities.Content.Workflow.Dto
{
    ...
    {
        /// <summary>Gets or sets subject of the message.</summary>
        public string Subject { get; set; }

        /// <summary>Gets or sets body of the message.</summary>
        public string Body { get; set; }

        /// <summary>Gets or sets a value indicating whether indicates if the message is going to be toasted or not. By default, it is False.</summary>
