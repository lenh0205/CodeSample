...
namespace DotNetNuke.Entities.Content.Workflow.Repositories
{
    ...
    /// <summary>This class is responsible to manage the workflow state permission entity.</summary>
    internal interface IWorkflowStatePermissionsRepository
    {
        /// <summary>Gets the registered permissions set for a specific state.</summary>
        ...
        /// <summary>Persists a new Workflow State Permission entity.</summary>
        ...
        /// <returns>The workflow state permission ID.</returns>
        int AddWorkflowStatePermission(WorkflowStatePermission permission, int lastModifiedByUserId);

        /// <summary>Deletes a specific Workflow State Permission entity.</summary>
