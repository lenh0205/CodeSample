...
namespace DotNetNuke.Entities.Content.Workflow
{
    ...
    /// <summary>This class is responsible to the management of the Workflow States.</summary>
    public interface IWorkflowStateManager
    {
        /// <summary>This method returns the list of States of a Workflow ordered by State Order ascending.</summary>
        ...
        /// <summary>This method returns the total number of Content Items that are associated with the State.</summary>
        ...
        /// <summary>This method returns a workflow State by Id.</summary>
        /// <param name="stateId">State Id.</param>
        /// <returns>State entity.</returns>
        WorkflowState GetWorkflowState(int stateId);

        /// <summary>This method adds a new State to a workflow. The new state is always added as next to last state.</summary>
        ...
        /// <summary>This method updates a State.</summary>
        ...
        /// <summary>This method hard deletes a state.</summary>
        ...
        /// <summary>This method move the state down to 1 position in the workflow state order.</summary>
        /// <remarks>This method takes care of state reordering.</remarks>
        /// <param name="stateId">State Id.</param>
        ...
        /// <summary>This method move the state up to 1 position in the workflow state order.</summary>
        /// <remarks>This method takes care of state reordering.</remarks>
        /// <param name="stateId">State Id.</param>
        /// <exception cref="DotNetNuke.Entities.Content.Workflow.Exceptions.WorkflowDoesNotExistException">Thrown when moving a state that does not exist.</exception>
        /// <exception cref="DotNetNuke.Entities.Content.Workflow.Exceptions.WorkflowInvalidOperationException">Thrown when state cannot be moved (i.e.: is the first/last state, etc...)</exception>
        ...
        /// <summary>This method move the state up to index position in the workflow state order.</summary>
        /// <remarks>This method takes care of state reordering.</remarks>
        /// <param name="stateId">State Id.</param>
        ...
        /// <summary>This method returns the list of State Permission of a specific state.</summary>
        /// <param name="stateId">State Id.</param>
        ...
        /// <summary>This method add a new workflow state permission.</summary>
        ...
        /// <summary>This method deletes a workflow state permission by Id.</summary>
