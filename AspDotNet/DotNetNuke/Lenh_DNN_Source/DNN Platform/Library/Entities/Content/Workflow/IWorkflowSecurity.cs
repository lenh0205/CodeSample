...
namespace DotNetNuke.Entities.Content.Workflow
{
    ...
    public interface IWorkflowSecurity
    {
        ...
        /// <summary>This method returns true if the current user has review permission on the specified state.</summary>
        /// <param name="stateId">State Id.</param>
        /// <returns>True if the user has review permission, false otherwise.</returns>
        bool HasStateReviewerPermission(int stateId);

        /// <summary>This method returns true if the user has review permission on at least one workflow state.</summary>
        ...
        /// <summary>This method gets the PermissionInfo of the State Review permission.</summary>
