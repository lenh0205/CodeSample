...
namespace DotNetNuke.Entities.Content.Workflow.Repositories
{
    ...
    /// <summary>This class is responsible to persist and retrieve workflow entity.</summary>
    internal interface IWorkflowRepository
    {
        /// <summary>This method gets the list of system portal workflows.</summary>
