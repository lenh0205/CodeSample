...
namespace DotNetNuke.Entities.Portals.Data
{
    ...
    public interface IDataService
    {
        ...
        /// <summary>Gets all shared modules with the specified Portal  by another owner portals.</summary>
        /// <param name="portal">The Portal.</param>
        /// <returns>A list of ModuleInfo objects.</returns>
        IDataReader GetSharedModulesWithPortal(PortalInfo portal);

        /// <summary>Gets all shared modules by the specified Portal with another portals.</summary>
