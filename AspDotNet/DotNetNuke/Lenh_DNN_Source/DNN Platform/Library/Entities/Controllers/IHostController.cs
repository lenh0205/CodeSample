...
namespace DotNetNuke.Entities.Controllers
{
    ...
    public interface IHostController
    {
        ...
        /// <summary>Gets an encrypted host setting as a <see cref="string"/>.</summary>
        /// <param name="key">The setting key string.</param>
        ...
        /// <summary>Takes in a <see cref="string"/> value, encrypts it with a FIPS compliant algorithm and stores.</summary>
