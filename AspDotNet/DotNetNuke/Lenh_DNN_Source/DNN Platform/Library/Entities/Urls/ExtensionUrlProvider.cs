...
namespace DotNetNuke.Entities.Urls
{
    ...
    /// <summary>This abstract class is to provide a inherited base class for a custom module friendly url provider.  All public methods must be overridden to provide the basis for a custom module provider.</summary>
    [Serializable]
    public abstract class ExtensionUrlProvider
    {
        ...
        /// </remarks>
        /// <returns><see langword="true"/> if this provider always uses the DNN page path for the given <paramref name="portalId"/>, otherwise <see langword="false"/>.</returns>
        public abstract bool AlwaysUsesDnnPagePath(int portalId);

        /// <summary>Generates a new friendly Url based on the parameters supplied.</summary>
        ...
        /// <summary>This module returns any custom settings for the provider in a key/value pair.  This is used when any customised settings are saved to the web.config file.</summary>
        ...
        /// <summary>Transforms a friendly Url into a querystring.  Used as input into the rewriting process, after the Url Rewriting process has identified the correct DNN Page.</summary>
        ...
        /// <summary>This method is called to check whether to do a Url Rewrite on all Tabs specified by the provider.</summary>
