...
namespace DotNetNuke.Entities.Tabs
{
    ...
    {
        /// <summary>Check if a page is published or not.</summary>
        /// <param name="tabID">Tha tab Id.</param>
        /// <param name="portalID">The portal ID where the tab is.</param>
        /// <returns><see langword="true"/> if the page is published, otherwise <see langword="false"/>.</returns>
        bool IsTabPublished(int tabID, int portalID);

        /// <summary>Set a page as published or unpublished.</summary>
        ...
        /// <summary>Check if Publish/Unpublish page actions can be performed.</summary>
        /// <param name="tabID">The tab ID.</param>
        /// <param name="portalID">The portal ID where the tab is.</param>
        /// <returns><see langword="true"/> if the page can be published/unpublished, otherwise <see langword="false"/>.</returns>
