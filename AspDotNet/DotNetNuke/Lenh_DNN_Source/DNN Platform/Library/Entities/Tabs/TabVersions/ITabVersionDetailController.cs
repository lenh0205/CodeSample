...
namespace DotNetNuke.Entities.Tabs.TabVersions
{
    ...
    /// <summary>Interface controller responsible to manage the tab version details.</summary>
    public interface ITabVersionDetailController
    {
        /// <summary>Gets a Tab Version Detail object of an existing Tab Version.</summary>
        ...
        /// <summary>Get all Tab Version Details of a existing version and earlier.</summary>
        ...
        /// <summary>Gets all TabVersionDetail objects of an existing TabVersion.</summary>
        ...
        /// <summary>Saves a Tab Version Detail object. Adds or updates an existing one.</summary>
        ...
        /// <summary>Saves a TabVersionDetail object. Adds or updates an existing one.</summary>
        /// <param name="tabVersionDetail">TabVersionDetail object to be saved.</param>
        ...
        /// <summary>Deletes a TabVersionDetail.</summary>
        ...
        /// <summary>Clears the tab version cache based on the tab version identifier.</summary>
