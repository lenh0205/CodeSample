...
namespace DotNetNuke.Entities.Tabs.TabVersions
{
    ...
    /// <summary>Controller interface responsible to manage tab versions.</summary>
    public interface ITabVersionController
    {
        /// <summary>Gets a Tab Version object of an existing Tab.</summary>
        ...
        /// <summary>Gets all Tab Versions of an existing Tab.</summary>
        ...
        /// <summary>Saves a Tab Version object. Adds or updates an existing one.</summary>
        ...
        /// <summary>Creates a new version for a existing Tab.</summary>
        /// <param name="tabId">The Tab Id to be queried.</param>
