...
namespace DotNetNuke.Security.Roles
{
    ...
    public interface IRoleController
    {
        ...
        /// <summary>Clears Roles cache for the passed portal ID and for the default ID (-1) as well.</summary>
        ...
        /// <summary>Fetch a single role based on a predicate.</summary>
        /// <param name="portalId">Id of the portal.</param>
        ...
        /// <summary>Persists a role to the Data Store.</summary>
        ...
        /// <summary>Update the role settings.</summary>
        ...
        /// <summary>Updates a Service (UserRole).</summary>
        /// <param name="portalId">The Id of the Portal.</param>
        /// <param name="userId">The Id of the User.</param>
        /// <param name="roleId">The Id of the Role.</param>
        /// <param name="status">The status of the Role.</param>
        /// <param name="isOwner">If the user is the owner of the Role.</param>
        /// <param name="cancel">A flag that indicates whether to cancel (delete) the user-role.</param>
