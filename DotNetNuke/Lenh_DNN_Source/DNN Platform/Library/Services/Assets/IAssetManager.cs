...
namespace DotNetNuke.Services.Assets
{
    ...
    {
        /// <summary>Gets the page of files and folders contained in the specified folder.</summary>
        ...
        /// <summary>Searches the files and folders contained in the specified folder.</summary>
        /// <param name="folderId">Folder Identifier.</param>
        ...
        /// <summary>Renames a existing file.</summary>
        ...
        /// <summary>Renames a existing folder.</summary>
