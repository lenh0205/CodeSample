...
namespace DotNetNuke.Services.FileSystem
{
    ...
    {
        /// <summary>Gets the alias name of the personal User Folder.</summary>
        ...
        /// <summary>Unlink the specified folder.</summary>
        /// <param name="folder">The folder to unlink.</param>
        void UnlinkFolder(IFolderInfo folder);

        /// <summary>Delete the specified folder and all its content.</summary>
        /// <param name="folder"> The folder to delete>.</param>
        ...
        /// <summary>Gets a folder entity by providing a portal identifier and folder identifier.</summary>
        ...
        /// <summary>Get the users folder.</summary>
        ...
        /// <summary>Synchronizes the specified folder, its files and its subfolders.</summary>
        /// <param name="portalId">The portal identifier.</param>
        /// <param name="relativePath">The relative path of the folder.</param>
        /// <returns>The number of folder collisions.</returns>
        int Synchronize(int portalId, string relativePath);

        /// <summary>Synchronizes the specified folder, its files and, optionally, its subfolders.</summary>
        /// <param name="portalId">The portal identifier.</param>
        /// <param name="relativePath">The relative path of the folder.</param>
