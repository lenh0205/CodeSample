...
namespace DotNetNuke.Services.FileSystem.Internal
{
    ...
    {
        /// <summary>Checks if the Current user is Host user or Admin user of the provided portal.</summary>
        ...
        /// <summary>Checks if the provided user is Host user or Admin user of the provided portal.</summary>
        /// <param name="portalId">Portal Id to check Admin users.</param>
        ...
        /// <summary>Checks if the provided permission is allowed for the current user in the provided folder.</summary>
