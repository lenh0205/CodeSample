...
namespace DotNetNuke.Services.FileSystem
{
    ...
    {
        /// <summary>Add a new version of the file.</summary>
        ...
        /// <summary>Changes the published version of a file.</summary>
        ...
        /// <summary>Gets the physical file with a specific version of a file.</summary>
        ...
        /// <summary>Deletes all the unpublished versions of a file.</summary>
        ...
        /// <summary>Returns all the versions of a file.</summary>
        /// <param name="file">The file with versions.</param>
        /// <returns>Collection of file versions.</returns>
        IEnumerable<FileVersionInfo> GetFileVersions(IFileInfo file);

        /// <summary>This method returns true if FileVersion is enabled in the Folder, false otherwise.</summary>
        ...
        /// <summary>This method returns true if FileVersion is enabled in the portal, false otherwise.</summary>
        ...
        /// <summary>This method returns the max number of versions for a portal.</summary>
        /// <param name="portalId">Portal Id.</param>
        /// <returns>Max file versions.</returns>
        int MaxFileVersions(int portalId);

        /// <summary>Rollbacks a file to the specified version.</summary>
        ...
        /// <summary>Get the content of a specific version file.</summary>
        ...
        /// <summary>Get all the non-published versions in a Folder.</summary>
        /// <param name="folderId">Folder Id.</param>
        /// <returns>Collection of file versions.</returns>
