...
namespace DotNetNuke.Services.Social.Notifications.Data
{
    ...
    public interface IDataService
    {
        ...
        /// <summary>Gets a Notification Type.</summary>
        ...
        /// <summary>Creates a new Notification Type Action.</summary>
        ...
        /// <summary>Deletes a Notification Type Action.</summary>
        ...
        /// <summary>Gets a Notification Type Action.</summary>
        ...
        /// <summary>Gets all the Notification Type Action of a Notification Type.</summary>
        ...
        /// <summary>Send a notification to its receivers.</summary>
        ...
        /// <summary>Deletes all the Notifications of a user.</summary>
        ...
        /// <summary>Gets the amount of Notifications of a user.</summary>
        ...
        /// <summary>Gets a paginated list of Notifications.</summary>
        ...
        /// <summary>Whether a Toast Notification is pending or not.</summary>
        ...
        /// <summary>Get a list of Toast Notifications that have not been delivered yet.</summary>
