...
namespace DotNetNuke.Services.Social.Notifications
{
    ...
    /// <summary>Defines the methods to work with Notifications, NotificationTypes, NotificationTypeActions and NotificationActions.</summary>
    public interface INotificationsController
    {
        ...
        /// <summary>Gets a notification type by identifier.</summary>
        /// <param name="notificationTypeId">The notification type identifier.</param>
        ...
        /// <summary>Gets a notification type by name.</summary>
        ...
        /// <summary>Deletes an existing notification type action.</summary>
        ...
        /// <summary>Gets a notification type action by identifier.</summary>
        /// <param name="notificationTypeActionId">The notification type action identifier.</param>
        ...
        /// <summary>Gets a notification type action by notification type and name.</summary>
        /// <param name="notificationTypeId">The notification type identifier.</param>
        ...
        /// <summary>Gets the list of notification type actions for the provided notification type.</summary>
        /// <param name="notificationTypeId">The notification type identifier.</param>
        ...
        /// <summary>Set the actions for a NotificationType.</summary>
        ...
        /// <summary>Creates a new notification and sets is sender as the portal administrator.</summary>
        ...
        /// <summary>Counts the notifications sent to the provided user in the specified portal.</summary>
        ...
        /// <summary>Gets a list of notifications sent to the provided user in the specified portal.</summary>
        /// <param name="userId">The user identifier.</param>
        /// <param name="portalId">The portal identifier.</param>
        ...
        /// <summary>Deletes all user notifications in a specific portal.</summary>
        ...
        /// <summary>Deletes an individual notification recipient.</summary>
        ...
        /// <summary>Deletes all NotificationRecipient for the NotificationId.</summary>
        /// <remarks>It also deletes the notification.</remarks>
        /// <param name="notificationId">The notification identifier.</param>
        void DeleteAllNotificationRecipients(int notificationId);

        /// <summary>Deletes an individual notification recipient based on NotificationTypeId, Context and UserId.</summary>
        /// <remarks>It also deletes the notification if there are no more recipients.</remarks>
        /// <param name="notificationTypeId">Id of the notification type.</param>
        ...
        /// <summary>Get a Notification by NotificationTypeId and Context.</summary>
        /// <param name="notificationTypeId">Id of the notification type.</param>
        /// <param name="context">Context set by creator of the notification.</param>
        /// <returns>The filtered list of notifications sent to the provided user in the specified portal.</returns>
        IList<Notification> GetNotificationByContext(int notificationTypeId, string context);

        /// <summary>Is there a Toast that needs to be sent for a Notification.</summary>
        ...
        /// <summary>Get a list of Toasts that have not been delivered yet.</summary>
