...
namespace DotNetNuke.Services.Social.Subscriptions
{
    ...
    public interface ISubscriptionController
    {
        ...
        /// <summary>Returns true if a user is subscribed to a Content.</summary>
        ...
        /// <summary>Adds a new Subscription. If the operation succeed the SubscriptionId property of the Subscription entity will be filled up.</summary>
        /// <param name="subscription">Subscription.</param>
