...
namespace DotNetNuke.Services.Search.Controllers
{
    ...
    /// <summary>BaseResult to be implemented by the different Crawlers to provide Permission and Url Services.</summary>
    ...
    {
        /// <summary>Gets the localized search type name.</summary>
        public virtual string LocalizedSearchTypeName => string.Empty;

        /// <summary>Does the user in the Context have View Permission on the Document.</summary>
        /// <param name="searchResult">Search Result.</param>
        /// <returns>True or False.</returns>
        public abstract bool HasViewPermission(SearchResult searchResult);

        /// <summary>Return a Url that can be shown in search results.</summary>
        /// <param name="searchResult">Search Result.</param>
        /// <returns>Url.</returns>
