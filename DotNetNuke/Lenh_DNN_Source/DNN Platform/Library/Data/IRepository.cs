...
namespace DotNetNuke.Data
{
    ...
    public interface IRepository<T>
        where T : class
    {
        /// <summary>Delete an Item from the repository.</summary>
        /// <param name="item">The item to be deleted.</param>
        void Delete(T item);

        /// <summary>Delete items from the repository based on a sql Condition.</summary>
        ...
        /// <summary>Find items from the repository based on a sql condition.</summary>
        ...
        /// <summary>Find a GetPage of items from the repository based on a sql condition.</summary>
        /// <remarks>Find supports both full SQL statements such as "SELECT * FROM table WHERE ..."
        /// as well as a SQL condition like "WHERE ...".</remarks>
        ...
        /// <summary>Returns a page of items in the repository as a paged list.</summary>
        /// <param name="pageIndex">The page Index to fetch.</param>
        /// <param name="pageSize">The size of the page to fetch.</param>
        /// <returns>The list of items.</returns>
        IPagedList<T> GetPage(int pageIndex, int pageSize);

        /// <summary>Returns a page of items in the repository as a paged list filtered by scope.</summary>
        /// <remarks>
        /// This overload should be used to get a list of items for a specific module
        /// instance or for a specific portal dependening on how the items in the repository
        /// are scoped.
        ...
        /// <summary>Inserts an Item into the repository.</summary>
        ...
        /// <summary>Update items in the repository based on a sql Condition.</summary>
