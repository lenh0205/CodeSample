...
namespace DotNetNuke.Entities.Tabs.TabVersions
{
    ...
    {
        /// <summary>Creates a new Tab Version checking current portal settings.</summary>
        ...
        /// <summary>Creates a new Tab Version.</summary>
        /// <param name="tabId">Tab Id whose version will be added.</param>
        /// <param name="createdByUserId">User Id which creates the version.</param>
        /// <returns>TabVersion filled with the new version data.</returns>
        TabVersion CreateNewVersion(int portalid, int tabId, int createdByUserId);

        /// <summary>Publish a Tab Version.</summary>
        ...
        /// <summary>Discards a Tab Version. If the tab only has an unpublished version, the page will keep but with no content and not published.</summary>
        ...
        /// <summary>Get all Modules Info associated with an specific version.</summary>
        ...
        /// <summary>Get the current pusblished version of the page.</summary>
        ...
        /// <summary>Get all Modules Info associated with the last published version of the page.</summary>
        /// <param name="tabId">Tab Id w.</param>
        /// <returns>List of ModuleInfo objects.</returns>
        IEnumerable<ModuleInfo> GetCurrentModules(int tabId);

        /// <summary>Rolls back an existing version.</summary>
        /// <param name="tabId">The Tab Id to be queried.</param>
        ...
        /// <summary>Deletes an existing Tab Version.</summary>
        /// <param name="tabId">The Tab Id to be queried.</param>
        ...
        /// <summary>Setup a first version for existing tab with modules. This method is used to create version 1 for pages created when versioning was not enabled.</summary>
