...
{
    /// <summary>Class responsible to provide settings for Tab Versioning.</summary>
    public interface ITabVersionSettings
    {
        /// <summary>Get the maximum number of version that the portal will kept for a tab.</summary>
        /// <param name="portalId">Portal Id.</param>
        /// <returns>Max number of version.</returns>
        int GetMaxNumberOfVersions(int portalId);

        /// <summary>Set the maximum number of version that the portal will kept for a tab.</summary>
        /// <param name="portalId">Portal Id.</param>
        ...
        /// <summary>Set the status of the tab versioning for the portal.</summary>
        /// <param name="portalId">Portal Id.</param>
        /// <param name="enabled">true for enable it, false otherwise.</param>
        void SetEnabledVersioningForPortal(int portalId, bool enabled);

        /// <summary>Set the status of the tab versioning for a tab.</summary>
        /// <param name="tabId">Tab Id.</param>
        /// <param name="enabled">true for enable it, false otherwise.</param>
        void SetEnabledVersioningForTab(int tabId, bool enabled);

        /// <summary>Get the status of the tab versioning for the portal.</summary>
        /// <param name="portalId">Portal Id.</param>
        ...
        /// <summary>Get the status of the tab versioning for an specific tab of the portal.</summary>
        /// <remarks>
        ...
        /// <summary>Get the query string parameter name to especify a Tab Version using the version number (i.e.: ?version=1).</summary>
        /// <param name="portalId">Portal Id.</param>
