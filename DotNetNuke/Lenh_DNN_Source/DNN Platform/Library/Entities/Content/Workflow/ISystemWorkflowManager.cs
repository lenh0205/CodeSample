...
namespace DotNetNuke.Entities.Content.Workflow
{
    ...
    public interface ISystemWorkflowManager
    {
        ...
        /// <summary>Gets a default definition of the 'Draft' system state.</summary>
        ...
        /// <summary>Gets a default definition of the 'Published' system state.</summary>
        /// <param name="order">Order number to be included in the state definition.</param>
        /// <returns>A 'Published' state definition.</returns>
        WorkflowState GetPublishedStateDefinition(int order);

        /// <summary>Gets a default definition of the 'Ready for review' system state.</summary>
        /// <param name="order">Order number to be included in the state definition.</param>
