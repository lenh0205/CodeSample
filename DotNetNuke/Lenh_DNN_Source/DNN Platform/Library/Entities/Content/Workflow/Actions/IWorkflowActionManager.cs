...
namespace DotNetNuke.Entities.Content.Workflow.Actions
{
    ...
    /// <summary>This class is responsible to manage Workflow Actions.</summary>
    public interface IWorkflowActionManager
    {
        /// <summary>This method gets an instance of the IWorkflowAction associated to the content type and action type.</summary>
        ...
        /// <summary>This method registers a new workflow action.</summary>
