...
namespace DotNetNuke.Entities.Content.Workflow.Repositories
{
    ...
    /// <summary>This class is responsible to persist and retrieve workflow action entity.</summary>
    internal interface IWorkflowActionRepository
    {
        /// <summary>This method gets the workflow action of a content type Id and action type.</summary>
        ...
        /// <summary>This method persists a new workflow action.</summary>
