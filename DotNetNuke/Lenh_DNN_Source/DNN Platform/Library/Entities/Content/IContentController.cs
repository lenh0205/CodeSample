...
namespace DotNetNuke.Entities.Content
{
    ...
    public interface IContentController
    {
        ...
        /// <summary>Get a list of content items by ContentType ID.</summary>
        ...
        /// <summary>Retrieve all content items associated with the specified module ID, <paramref name="moduleId"/>.</summary>
        ...
        /// <summary>Retrieve all content items on the specified page (tab).</summary>
