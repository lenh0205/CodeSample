...
namespace DotNetNuke.Entities.Content
{
    ...
    {
        /// <summary>Add a generic file to a <see cref="ContentItem"/>.</summary>
        ...
        /// <summary>Add a video file to a <see cref="ContentItem"/>.</summary>
        /// <param name="contentItemId">The content item.</param>
        /// <param name="fileInfo">A file registered in the DotNetNuke. <seealso cref="FileManager"/></param>
        ...
        /// <summary>Attach an image to a ContentItem.</summary>
        /// <param name="contentItemId">The content item.</param>
        /// <param name="fileInfo">A file registered in the DotNetNuke. <seealso cref="FileManager"/></param>
