...
namespace DotNetNuke.Collections
{
    ...
    /// <summary>  Contains filters that can be applied to <see cref = "IEnumerable" /> stores.</summary>
    public static class PagingExtensions
    {
        /// <summary>  Filters the incoming store to retrieve pages of a specified size.</summary>
        ...
        /// <summary>Converts an <see cref="IEnumerable{T}"/> into an <see cref="IPagedList{T}"/>.</summary>
