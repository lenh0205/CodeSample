...
namespace DotNetNuke.Security.Permissions
{
    ...
    /// <summary>WorkflowStatePermissionController provides the Business Layer for DesktopModule Permissions.</summary>
    public class WorkflowStatePermissionController
    {
        ...
        /// <summary>GetWorkflowStatePermissions gets a WorkflowStatePermissionCollection.</summary>
        /// <param name="stateID">The ID of the State.</param>
        /// <returns>The permissions for the given workflow state.</returns>
        ...
        /// <summary>HasWorkflowStatePermission checks whether the current user has a specific WorkflowState Permission.</summary>
        ...
        /// <summary>GetWorkflowStatePermissions gets a Dictionary of WorkflowStatePermissionCollections by WorkflowState.</summary>
        ...
        /// <summary>GetWorkflowStatePermissionsCallBack gets a Dictionary of WorkflowStatePermissionCollections by WorkflowState from the the Database.</summary>
        ...
        /// <summary>FillWorkflowStatePermissionDictionary fills a Dictionary of WorkflowStatePermissions from a dataReader.</summary>
