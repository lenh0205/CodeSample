...
namespace Dnn.PersonaBar.Extensions.Components
{
    ...
    {
        InstallResultDto InstallPackage(PortalSettings portalSettings, UserInfo user, string legacySkin, string fileName, Stream stream, bool isPortalPackage = false);
